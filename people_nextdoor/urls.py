"""people_nextdoor URL Configuration
...
from neighbourhood import views as user_views
...
urlpatterns = [
    ...
    path('login/', auth_views.LoginView.as_view(template_name='neighbourhood/login.html'), name='login'),
